<?php
function staff_member_data_form( $post, $plugin_name, $memberData, $positionTerms ) { ?>
            ...
            <div class="row">
                <div class="member_name">
                    ...
                    <input type="text" id="member_name" name="member_name"
                           value="<?php echo $memberData['member_name']; ?>" />
                </div>
                ...
                <div class="member_position">
                    ...
                    <select name="member_position" id="member_position">
						<?php foreach ( $positionTerms as $position ) : ?>
							<?php $selected = ($memberData['member_position'] == $position->term_id ? 'selected' : '' ) ?>
