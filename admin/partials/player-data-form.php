        ...
        <div class="form">
            <div class="row">
                <div class="player_name">
                    ...
                    <input type="text" id="player_name" name="player_name"
                           value="<?php echo $playerData['player_name']; ?>" />
                </div>
            ...
            <div class="row">
                <div class="total_games">
                    ...
                    <input type="text" id="player_total_games" name="player_total_games"
                           value="<?php echo $playerData['player_total_games']; ?>" />
                </div>

                <div class="player_total_points">
                    <label for="player_total_points"><?php echo __( "Total points", $plugin_name ); ?></label>
                    <input type="text" id="player_total_points" name="player_total_points"
                           value="<?php echo $playerData['player_total_points']; ?>" />
                </div>

                <div class="player_total_3_pointers">
                    <label for="player_total_3_pointers"><?php echo __( "Total 3-pointers", $plugin_name ); ?></label>
                    <input type="text" id="player_total_3_pointers" name="player_total_3_pointers"
                           value="<?php echo $playerData['player_total_3_pointers']; ?>" />
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="player_nationality">
                    ...
                    <input type="text" id="player_nationality" name="player_nationality"
                           value="<?php echo $playerData['player_nationality']; ?>"/>
                </div>

                <div class="player_weight">
                    <label for="player_weight"><?php echo __( "Weight", $plugin_name ); ?></label>
                    <input type="text" id="player_weight" name="player_weight"
                           value="<?php echo $playerData['player_weight']; ?>" />
                </div>

                <div class="player_height">
                    <label for="player_height"><?php echo __( "Height", $plugin_name ); ?></label>
                    <input type="text" id="player_height" name="player_height"
                           value="<?php echo $playerData['player_height']; ?>" />
                </div>
            </div>
        </div>
    </div>
